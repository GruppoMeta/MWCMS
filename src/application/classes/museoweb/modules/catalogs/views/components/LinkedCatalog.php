<?php
class museoweb_modules_catalogs_views_components_LinkedCatalog extends org_glizy_components_RecordSetList
{
    function init()
    {
    ...
    public function process()
    {
        ...
        if (is_array($values) && count($values)) {
            $iterator = org_glizy_ObjectFactory::createModelIterator('museoweb.modules.catalogs.models.Model');
